...
module.exports = async () => {
  ...
  const missingFlowFileFacts =
    missingFlowFileStrings.length === 0
      ? []
      : [
          {
            title: "AcosId",
  ...
  const blobsWithProblemsFacts =
    blobsWithProblems.length === 0
      ? []
      : [
          {
            title: "Blob",
  ...
  const willNotRunAgainFacts =
    willNotRunAgainBlobs.length === 0
      ? []
      : [
          {
            title: "Acos refId",
  ...
  const waitingRefIdsFacts =
    formsInAvleveringWithoutUtenlandsreisende.length === 0
      ? []
      : [
          {
            title: "Acos refId",
