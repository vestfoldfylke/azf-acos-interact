...
module.exports = async (jobDef, flowStatus) => {
  ...
  logger.info('syncElevmappe: Successfully synced elevmappe. PrivatePerson recNo: {RecNo}, Elevmappe saksnummer: {CaseNumber}', data.privatePerson.recno, data.elevmappe.CaseNumber)
  return data
}
