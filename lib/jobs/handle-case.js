...
module.exports = async (jobDef, flowStatus) => {
  ...
  if (getCaseParameter) {
    ...
    */
    ...
    if (data.length >= 1) {
      ...
      logger.info('handleCase: Found case with getCase parameter. CaseNumber: {CaseNumber}', data[0].CaseNumber)
  ...
  logger.info('handleCase: Successfully handled case. CaseNumber: {CaseNumber}', data.CaseNumber)
  return data
}
