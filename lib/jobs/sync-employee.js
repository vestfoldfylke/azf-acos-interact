...
module.exports = async (jobDef, flowStatus) => {
  ...
  logger.info(
    "syncEmployee: Successfully synced employee. PrivatePerson recNo: {PrivatePersonRecNo}, Enterprise recNo: {EnterpriseRecNo}, Manager recNo: {ManagerRecNo}",
    data.privatePerson.recno,
    data.responsibleEnterprise.recno,
    data.archiveManager.recno
  )
  return data
}
