    ...
    options: {
      ...
      */
      mapper: (flowStatus, base64, attachments) => {
        ...
        const school = schoolInfo.find(school => school.orgNr.toString() === jsonData.SavedValues.Dataset.Skole2.Orgnr)
        if (!school) throw new Error(`Could not find any school with orgnr: ${jsonData.SavedValues.Dataset.Skole2.Orgnr}`)
        ...
        return {
          ...
          parameter: {
            ...
            ResponsibleEnterpriseNumber: jsonData.SavedValues.Dataset.Skole2.Orgnr,
