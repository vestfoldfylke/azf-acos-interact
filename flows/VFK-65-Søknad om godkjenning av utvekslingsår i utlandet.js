    ...
    options: {
      ...
      */
      mapper: (flowStatus, base64, attachments) => {
        ...
        const school = schoolInfo.find(school => school.orgNr.toString() === jsonData.SavedValues.Dataset.Skole_i_Norge1.Orgnr)
        if (!school) throw new Error(`Could not find any school with orgnr: ${jsonData.SavedValues.Dataset.Skole_i_Norge1.Orgnr}`)
            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Søknad om godkjenning av utvekslingsår i utlandet',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            Paragraph: 'Offl. § 13 jf. fvl. § 13 (1) nr.1',
            ResponsibleEnterpriseNumber: jsonData.SavedValues.Dataset.Skole_i_Norge1.Orgnr,
            // ResponsiblePersonEmail: '',
            Status: 'J',
            Title: 'Søknad om godkjenning av utvekslingsår i utlandet',
            // UnofficialTitle: `Søknad om godkjenning av utvekslingsår i utlandet - ${xmlData.Fornavn} ${xmlData.Etternavn}`,
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          department: '',
          description,
          type: 'Søknad om godkjenning av utvekslingsår i utlandet', // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
