        ...
        return [
          {
            ...
            fields: {
              Tilgang_x0020_til_x0020_360: `Tilgang til opplæring gitt (${xmlData.utfortAvTidspunkt})`
            }
          }
        ]
      }
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description,
          type: 'Tannhelse - bestilling av tilganger - P360 - spillbasert opplæring' // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
