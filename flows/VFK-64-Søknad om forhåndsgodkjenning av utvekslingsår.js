    ...
    options: {
      ...
      */
      mapper: (flowStatus, base64, attachments) => {
        ...
        const school = schoolInfo.find(school => school.orgNr.toString() === jsonData.SavedValues.Dataset.Skole_i_Norge.Orgnr)
        if (!school) throw new Error(`Could not find any school with orgnr: ${jsonData.SavedValues.Dataset.Skole_i_Norge.Orgnr}`)
            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Søknad om forhåndsgodkjenning av utvekslingsår',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            Paragraph: 'Offl. § 13 jf. fvl. § 13 (1) nr.1',
            ResponsibleEnterpriseNumber: jsonData.SavedValues.Dataset.Skole_i_Norge.Orgnr,
            // ResponsiblePersonEmail: '',
            Status: 'J',
            Title: 'Søknad om forhåndsgodkjenning av utvekslingsår',
            UnofficialTitle: `Søknad om forhåndsgodkjenning av utvekslingsår - ${flowStatus.parseJson.result.SavedValues.Login.FirstName} ${flowStatus.parseJson.result.SavedValues.Login.LastName}`,
