  ...
  syncPrivatePersonInnsender: {
    ...
    options: {
      condition: (flowStatus) => { // use this if you only need to archive some of the forms.
        return flowStatus.parseJson.result.DialogueInstance.Bruk_av_vei__og_sidearea.Søker.Jeg_søker_som === 'Tiltakshaver' && flowStatus.parseJson.result.DialogueInstance.Bruk_av_vei__og_sidearea.Søker.Tiltakshaver === 'Privatperson'
      },
        ...
        return [
          {
            ...
            fields: {
              ...
              Organisasjonsnummer: jsonData.Konsulent_tredj.Organisasjon7.Organisasjonsnu6 || jsonData.Tiltakshaver_or.Organisasjon5.Organisasjonsnu4 || jsonData.Utførende2.Organisasjon6.Organisasjonsnu5 || 'Ingen organisasjon',
              Organisasjonsnavn: jsonData.Konsulent_tredj.Organisasjon7.Organisasjonsna6 || jsonData.Tiltakshaver_or.Organisasjon5.Organisasjonsna4 || jsonData.Utførende2.Organisasjon6.Organisasjonsna5 || 'Ingen organisasjon',
