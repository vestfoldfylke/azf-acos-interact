    ...
    options: {
      ...
      */
      mapper: (flowStatus, base64, attachments) => {
        ...
        const veg = jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2.Kommunal__eller_fylkesve && jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2Vegnummer2 ? `${jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2.Kommunal__eller_fylkesve}${jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2Vegnummer2} - ` : ''
        ...
        const NavnHoldningsskapendeTiltak = jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2.Navn_pa_holdningsskapend ? `Holdningstiltak - ${jsonData.Bakgrunnsinformasjon.Bakgrunnsinformasjon2.Navn_pa_holdningsskapend}` : ''
