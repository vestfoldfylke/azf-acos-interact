            ...
            Contacts: [
              {
                Role: "Avsender",
                ReferenceNumber:
                  jsonData.DialogueInstance.Informasjon_om_.Hvem_represente === "Privatperson"
                    ? jsonData.SavedValues.Login.UserID
                    : jsonData.DialogueInstance.Informasjon_om_.Organisasjon.Organisasjonsnu.replaceAll(" ", ""), // Hvis privatperson skal FNR benyttes, hvis ikke skal orgnr brukes
                IsUnofficial: false
              }
            ],
