        ...
        return [
          {
            ...
            fields: {
              Title: xmlData.nyTilgangNavn || 'Mangler etternavn', // husk å bruke internal name på kolonnen
              Fornavn: xmlData.fornavn,
              e_x002d_post: xmlData.epost,
              Mobil: xmlData.mobil,
              Org_x002f_firma: xmlData.orgFirma,
              E_x002d_post_x0020_for_x0020_fak: xmlData.fakturaEpost, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
              Fakturaadresse: xmlData.fakturaadresse, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
              Postnr: xmlData.postnr, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
              Poststed: xmlData.poststed, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
              Fakturareferanse: xmlData.fakturaReferanse, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
              Arbeidsomr_x00e5_de: xmlData.arbeidsomrade, // === 'true' ? `Bestilt (${xmlData.tidspunkt})` : 'Ikke bestilt',
