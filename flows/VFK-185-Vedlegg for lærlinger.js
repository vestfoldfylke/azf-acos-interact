    ...
    options: {
      ...
      */
      mapper: (flowStatus, base64, attachments) => {
        ...
        let skole = false
        if (jsonData.DialogueInstance.Informasjon_om_.Om_skjemaet === "Jeg fyller ut skjemaet sammen med YFF-lærer, kontaktlærer eller rådgiver") {
          // Skolen skal være ansvarlig og ha tilgang
          skole = true
        }
        ...
        const documentData = {
          ...
          parameter: {
            ...
            ResponsibleEnterpriseRecno: nodeEnv === "production" ? "262220" : "200733", // Fagopplæring
