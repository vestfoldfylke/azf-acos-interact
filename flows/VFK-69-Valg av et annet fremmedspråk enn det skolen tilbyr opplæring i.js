            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Søknad om fritak fra opplæring i fremmedspråk',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            Paragraph: 'Offl. § 13 jf. fvl. § 13 (1) nr.1',
            ResponsibleEnterpriseNumber: jsonData.SavedValues.Dataset.Velg_skole.Orgnr,
            // ResponsiblePersonEmail: '',
            Status: 'J',
            Title: 'Søknad om fritak fra opplæring i fremmedspråk',
            // UnofficialTitle: `Søknad om fritak fra opplæring i fremmedspråk - ${xmlData.Fornavn} ${xmlData.Etternavn}`,
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          department: '',
          description,
          type: 'Søknad om fritak fra opplæring i fremmedspråk', // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
