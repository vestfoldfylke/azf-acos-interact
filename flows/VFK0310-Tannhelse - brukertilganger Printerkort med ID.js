        ...
        return [
          {
            ...
            fields: {
              Printerkort_x0020_med_x0020_ID: `Utført (${xmlData.utfortAvTidspunkt})`
            }
          }
        ]
      }
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description,
          type: 'Tannhelse - bestilling av tilganger - Printerkort med ID' // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
