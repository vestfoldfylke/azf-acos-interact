      ...
      mapper: (flowStatus, base64, attachments) => {
        ...
        return {
          ...
          parameter: {
            ...
            Files: [
              {
                ...
                Format: 'pdf',
                Status: 'F',
                Title: 'Takker nei til tilbud om særskilt språkopplæring',
                VersionFormat: 'A'
              },
              ...p360Attachments
            ],
            ...
            Status: 'J',
            Title: 'Takker nei til tilbud om særskilt språkopplæring',
            UnofficialTitle: `Takker nei til tilbud om særskilt språkopplæring - ${flowStatus.parseJson.result.SavedValues.Login.FirstName} ${flowStatus.parseJson.result.SavedValues.Login.LastName}`,
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          department: '',
          description,
          type: 'Takker nei til tilbud om særskilt språkopplæring', // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
