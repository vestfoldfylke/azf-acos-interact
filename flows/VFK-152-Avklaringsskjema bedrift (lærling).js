    ...
    options: {
      ...
      */
      mapper: (flowStatus) => { // for å opprette person basert på fødselsnummer
        ...
        return {
          ssn: flowStatus.parseJson.result.DialogueInstance.Kontaktinformas.Kontaktinformas.Fødselsnummer
        }
      }
    }
  },
      ...
      mapper: (flowStatus, base64, attachments) => {
        ...
        return {
          ...
          parameter: {
            ...
            Contacts: [
              {
                ReferenceNumber: flowStatus.parseJson.result.DialogueInstance.Kontaktinformas.Kontaktinformas.Fødselsnummer,
                Role: 'Avsender',
                IsUnofficial: true
              },
              {
