        ...
        return [
          {
            ...
            fields: {
              TilgangtilOpus: `Utført (${xmlData.utfortAvTidspunkt})`
            }
          }
        ]
      }
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          description,
          type: 'Tannhelse - bestilling av tilganger - Opus' // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
