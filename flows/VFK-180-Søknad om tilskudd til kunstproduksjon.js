            ...
            Contacts: [
              {
                Role: "Avsender",
                ReferenceNumber:
                  jsonData.Informasjon_om_.Type_søker.Jeg_søker_på_ve === "meg selv (som privatperson)"
                    ? flowStatus.parseJson.result.SavedValues.Login.UserID
                    : jsonData.Informasjon_om_.Organisasjon1.Organisasjon.Organisasjonsnu.replaceAll(" ", ""),
                IsUnofficial: false
              }
            ],
            Files: [
            ...
            fields: {
              Title:
                jsonData.Informasjon_om_.Type_søker.Jeg_søker_på_ve === "meg selv (som privatperson)"
                  ...
                  : `${jsonData.Informasjon_om_.Organisasjon1.Organisasjon.Organisasjonsna} - ${jsonData.Informasjon_om_.Organisasjon1.Kontaktperson}`,
