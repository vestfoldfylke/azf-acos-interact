        ...
        return [
          {
            ...
            fields: {
              ...
              Tilgang_x0020_navn:
                jsonData.Tilgang_til_his.Hvem_skal_ha_ti === "Meg selv"
                  ? `${flowStatus.parseJson.result.SavedValues.Login.FirstName} ${flowStatus.parseJson.result.SavedValues.Login.LastName}`
                  : jsonData.Tilgang_til_his.Informasjon_om_.Navn_på_ansatt,
              Tilgang_x0020_e_x002d_post:
                jsonData.Tilgang_til_his.Hvem_skal_ha_ti === "Meg selv" ? flowStatus.parseJson.result.SavedValues.Login.Email : jsonData.Tilgang_til_his.Informasjon_om_.E_post,
