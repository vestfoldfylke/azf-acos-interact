...
module.exports = {
  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        const jsonData = flowStatus.parseJson.result
        const fagKodeliste = Array.isArray(jsonData.DialogueInstance.Registrering_av_fravar_o.Fag)
          ? jsonData.DialogueInstance.Registrering_av_fravar_o.Fag
          : [jsonData.DialogueInstance.Registrering_av_fravar_o.Fag] // Sjekker om det er mer enn ett fag i lista (altså et array). Hvis ikke lag et array med det ene elementet
