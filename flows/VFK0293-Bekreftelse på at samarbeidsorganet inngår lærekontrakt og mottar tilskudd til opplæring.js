  ...
  sharepointList: {
    ...
    options: {
      mapper: (flowStatus) => {
        const xmlData = flowStatus.parseXml.result.ArchiveData
        let bekreftelse = "Nei"
        if (xmlData.Bekreftelse === "true") {
          bekreftelse = "Ja"
        }
        return [
          {
            testListUrl:
              "https://vestfoldfylke.sharepoint.com/sites/OPT-Fylkesadministrasjonopplring-Listerfag-ogyrkesopplring/Lists/Bekreftelser%20p%20at%20samarbeidsorgan%20kan%20inng%20lrekont/AllItems.aspx",
            prodListUrl:
              "https://vestfoldfylke.sharepoint.com/sites/OPT-Fylkesadministrasjonopplring-Listerfag-ogyrkesopplring/Lists/Bekreftelser%20p%20at%20samarbeidsorgan%20kan%20inng%20lrekont/AllItems.aspx",
            uploadFormPdf: true,
