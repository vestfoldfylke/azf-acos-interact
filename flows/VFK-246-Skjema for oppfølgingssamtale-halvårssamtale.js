const description = "Skjema for oppfølgingssamtale - halvårssamtale"
      ...
      mapper: (flowStatus) => {
        return {
          ...
          parameter: {
            ...
            UnofficialTitle: `Oppfølgingssamtale - ${flowStatus.parseJson.result.DialogueInstance.Deltagere.Medarbeider.Navn}`,
            Status: "B",
            AccessCode: "13",
    ...
    options: {
      mapper: (flowStatus) => {
        ...
        return {
          ...
          department: "HR",
          description,
          type: "Oppfølgingssamtale", // Required. A short searchable type-name that distinguishes the statistic element
          // optional fields:
